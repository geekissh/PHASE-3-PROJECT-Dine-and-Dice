...
if __name__ == '__main__':
    ...
    title = pyfiglet.figlet_format("Dine and Dice Thai Food", font="big")
    print(title)
    
    print("Welcome to Dine and Dice Thai Food!")
    print("-" * 70)
    ...
    while True:
        ...
        try:
            ...
            print("5. Leave the Dine and Dice")
            ...
            if choice == 1:
                ...
                print("-" * 70)
                print("Thank you for stopping by Dine and Dice Thai Food!")
